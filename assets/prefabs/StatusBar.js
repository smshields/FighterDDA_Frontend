...
export default class StatusBar extends Phaser.GameObjects.Container {
	...
	constructor(scene, x, y) {
		...
		// bitmaptext_1
		const bitmaptext_1 = scene.add.bitmapText(165, 10, "vcr_osd_mono_bold", "Character Name");
		...
		// bitmaptext_2
		const bitmaptext_2 = scene.add.bitmapText(60, 50, "vcr_osd_mono", "HEALTH");
		...
		// bitmaptext
		const bitmaptext = scene.add.bitmapText(60, 90, "vcr_osd_mono", "ACTION");
